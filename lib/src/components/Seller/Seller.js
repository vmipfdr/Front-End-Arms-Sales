  ...
  render() {
    return (
      <div>
        ...
        <h1>You are searching for {this.state.sellerCode} Sales</h1>
        <h2>
          There are {this.state.salesData.length} {this.state.sellerCode} sale
          records available from 1998 to 2018
        </h2>
